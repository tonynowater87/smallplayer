...
public class U2BVideoQUeryArray<PlayListSongEntity> extends BaseQueryArrayList {
    ...
    public U2BVideoQUeryArray(U2BQueryParamsItem u2BQueryParamsItem, IOnU2BQuery callback) {
        super(u2BQueryParamsItem, callback);
    }

    @Override
    public void query() {
        U2BApi.newInstance().queryU2BVideo(ueryParamsItem, new U2BApi.OnNewCallback<com.tonynowater.smallplayer.module.dto.realm.entity.PlayListSongEntity>() {
            @Override
